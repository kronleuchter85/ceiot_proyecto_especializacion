...
void mqtt_service_task(void * pvParameters)
{
    ...
    while(1){
        ...
        for (int i = 0; i < NUM_DEVICES; i++) {
            ...
            sprintf(body, BODY, getDeviceByIndex(i) , "Temperature" , state.temperature  , latitude, longitude, date_str , time_str);
            ...
            //
            memset(body , '\0' , sizeof(body));
            sprintf(body, BODY, getDeviceByIndex(i) , "Humidity" , state.humidity   , latitude, longitude, date_str , time_str);
            esp_mqtt_client_publish(client, "readings", body, strlen(body), 1, 0);
            ...
            //
            memset(body , '\0' , sizeof(body));
            sprintf(body, BODY, getDeviceByIndex(i) , "Pressure" , state.pressure  , latitude, longitude , date_str , time_str);
            esp_mqtt_client_publish(client, "readings", body, strlen(body), 1, 0);
            ...
            //
            memset(body , '\0' , sizeof(body));
            sprintf(body, BODY, getDeviceByIndex(i) , "Luminosity" , state.light , latitude, longitude , date_str , time_str);
            esp_mqtt_client_publish(client, "readings", body, strlen(body), 1, 0);
